...
const goToLogin = () => router.replace({ name: 'sign-in' })
            ...
            <div class="row d-flex align-items-center justify-content-center h-100 g-0 px-4 px-sm-0">
                <div class="col col-sm-6 col-lg-8 col-xl-8">
                    <div class="d-flex justify-content-center">
                        <img src="/fav/android-chrome-192x192.png" alt="selflix" width="58">
                    </div>
                    ...
                    <template v-else>
                        <div class="text-center mb-7">
                            <h3 class="text-1000">Sign out</h3>
                            <p class="text-700">You are now signed out.</p>
                        </div>
                        <button class="btn btn-primary w-100 mb-3" @click="goToLogin">Sign in again</button>
                    </template>
                </div>
            </div>
        </div>
